...
try {
    ...
    winget.exe install -e --id Postman.Postman --silent --scope=user --accept-package-agreements --accept-source-agreements
  
    # Verify the installation
    $appPath = "$env:USERPROFILE\AppData\Local\Postman\Postman.exe"
